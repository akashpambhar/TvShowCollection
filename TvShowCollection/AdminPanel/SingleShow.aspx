<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AdminPanel.master" AutoEventWireup="true" CodeFile="SingleShow.aspx.cs" Inherits="AdminPanel_SingleShow" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainBody" runat="Server">
    <div class="hero sr-single-hero sr-single" style="background: #020d18;"></div>
    <div class="page-single movie-single movie_single">
        <div class="container">
            <div class="row ipad-width2">
                <asp:Repeater runat="server" ID="rptShowID" OnItemDataBound="rptShowID_ItemDataBound">
                    <ItemTemplate>
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="movie-img sticky-sb" style="padding-top: 10px;">
                                <asp:Image runat="server" ImageUrl="<%# ((TvShowCollection.ENT.ShowENT)Container.DataItem).Image.Original %>" alt="" />
                            </div>
                        </div>
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="movie-single-ct main-content">
                                <h1 class="bd-hd"><%# Eval("name") %> <span>2007 - current</span></h1>
                                <div class="movie-rate">
                                    <div class="rate">
                                        <i class="ion-android-star"></i>
                                        <p>
                                            <span><%# ((TvShowCollection.ENT.ShowENT)Container.DataItem).Rating.Average.ToString() %></span> /10<br />
                                        </p>
                                    </div>
                                </div>
